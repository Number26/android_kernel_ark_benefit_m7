...
/*add by xieyue at 20150512*/
#if defined(CONFIG_T89P_HD_PROJ)
...
{
#define SPK_WARM_UP_TIME        (55) //unit is ms  //liuyang modify 25 to 55 
#ifndef CONFIG_FPGA_EARLY_PORTING
    int ret;
    ...
    if (enable)
    {
		...
		AW8736_MODE4;
    #else
	#if defined(CONFIG_T93BQ_PROJ) || defined(CONFIG_T89N_TS_PROJ)
		AW8736_MODE2;
	#else
        	AW8736_MODE3;
	#endif
...
static void Receiver_Speaker_Switch_Change(bool enable)
{
    ...
    if (enable)
    {
        ...
        mt_set_gpio_out(pin_rcvspkswitch, GPIO_OUT_ONE); // switch to receiver
    ...
    else
    {
        ...
        mt_set_gpio_pull_enable(pin_rcvspkswitch, GPIO_PULL_ENABLE);
        mt_set_gpio_dir(pin_rcvspkswitch, GPIO_DIR_OUT); // output
        mt_set_gpio_out(pin_rcvspkswitch, GPIO_OUT_ZERO); // switch to speaker
