...
static struct LCM_setting_table lcm_initialization_setting[] = {
	...
	{0xC8,38,{0x7E,0x61,0x4F,0x41,0x3C,0x2D,0x30,0x19,0x31,0x2E,0x2E,0x4D,0x3C,0x43,0x34,0x2F,0x21,0x0E,0x01,
                  0x7E,0x61,0x4F,0x41,0x3C,0x2D,0x30,0x19,0x31,0x2E,0x2E,0x4D,0x3C,0x43,0x34,0x2F,0x21,0x0E,0x01}}, 
	...
	{0xD4,16,{0x1F,0x1E,0x05,0x07,0x01,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F}},
        ...
        {0xD6,16,{0x1F,0x1F,0x06,0x04,0x00,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F}},
        {0xD7,16,{0x1F,0x1F,0x07,0x05,0x01,0x1E,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F,0x1F}},
      
        {0xD8,20,{0x20,0x00,0x00,0x10,0x03,0x20,0x01,0x02,0x00,0x01,0x02,0x36,0x4F,0x00,0x00,0x32,0x04,0x36,0x4F,0x08}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
		...
		params->dsi.vertical_sync_active				= 4;// 4;2    //2
		params->dsi.vertical_backporch					= 6;// 8;2   //8
		params->dsi.vertical_frontporch					= 30;// 8;2;//16
		params->dsi.vertical_active_line				= FRAME_HEIGHT; 

		params->dsi.horizontal_sync_active				= 10;//6   //20
		params->dsi.horizontal_backporch				= 50;//37  //20
		params->dsi.horizontal_frontporch				= 50;//37  //20
...
#if defined(BUILD_LK)
	printf("jd9161 id=%x, %x %x\n", id, id1, id2);
#else
	printk("jd9161 id=%x, %x %x\n", id, id1, id2);
#endif
...
LCM_DRIVER hct_jd9161_dsi_vdo_wvga_boe = 
{
.name = "hct_jd9161_dsi_vdo_wvga_boe",
