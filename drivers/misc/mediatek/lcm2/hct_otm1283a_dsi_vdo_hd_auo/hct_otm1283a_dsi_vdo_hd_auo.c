...
static struct LCM_setting_table lcm_initialization_setting[] = {
  ...
  {0x00,1,{0x92}},	            
  {0xff,2,{0x30,0x02}},      //MIPI 4lane LANSEL=1㊣?D??車
...
//-------------------- power setting --------------------//
	...
	{0x00,1,{0x91}},             //VGH=15.5V, VGL=-10V, pump ratio:VGH=7x, VGL=-5x
	{0xc5,2,{0x56,0x90}},
...
//-------------------- for Power IC ---------------------------------
  ...
  {0x00,1,{0x80}}, 
  {0xC4,1,{0x30}},    //non-display area source pre-charge to VSS.
         
  {0x00,1,{0x8b}}, 
  {0xC4,1,{0x00}},    //non-display area source pre-charge to VSS.
         
  {0x00,1,{0xc3}},    //Sample hold all on 
  {0xf5,1,{0x81}},   
...
// ***********************CELEVER COLOR SETTING FOR CE ****************************************//
	{0x00,1,{0xa0}},
	{0xd6,12,{0x01,0xCD,0x01,0xCD,0x01,0xCD,0x01,0xCD,0x01,0xCD,0x01,0xCD}},  //12P
  {0x00,1,{0xB0}},  
	{0xd6,12,{0x01,0xCD,0x01,0xCD,0x01,0xCD,0x01,0xCD,0x01,0xCD,0x01,0xCD}},  //12P
	{0x00,1,{0xC0}},  
	{0xD6,12,{0x89,0x11,0x89,0x89,0x11,0x89,0x89,0x11,0x89,0x89,0x11,0x89}},//12P
  {0x00,1,{0xD0}},             
	{0xD6,6,{0x89,0x11,0x89,0x89,0x11,0x89}},//6P
	{0x00,1,{0xE0}},             
	{0xD6,12,{0x44,0x11,0x44,0x44,0x11,0x44,0x44,0x11,0x44,0x44,0x11,0x44}},//12P
	{0x00,1,{0xF0}},             
	{0xD6,6,{0x44,0x11,0x44,0x44,0x11,0x44}},//6P
	{0x00,1,{0x00}},	            //Orise mode disable
	{0xFF,3,{0xFF,0xFF,0xFF}},//3P	
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_otm1283a_dsi_vdo_hd_auo = 
{
	.name			= "hct_otm1283a_dsi_vdo_hd_auo",
