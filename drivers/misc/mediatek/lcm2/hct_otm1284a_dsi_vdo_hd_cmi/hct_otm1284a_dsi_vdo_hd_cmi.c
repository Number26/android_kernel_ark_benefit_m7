...
//-------------------- panel timing setting --------------------//
	...
	{0x00,1,{0x00}},
	{0xE1,20,{0x0d,0x15,0x1d,0x24,0x31,0x3b,0x3b,0x63,0x55,0x6f,0x93,0x7a,0x87,0x5c,0x54,0x44,0x34,0x25,0x1b,0x17}},

	{0x00,{0x00}},
	{0xE2,20,{0x0d,0x15,0x1d,0x24,0x30,0x3b,0x3b,0x63,0x55,0x6e,0x93,0x7a,0x87,0x5c,0x54,0x44,0x34,0x25,0x1b,0x17}},
...
//	}
    ...
    */
	...
	//printk("[%s] hct_otm1284a_dsi_vdo_hd_cmi %x\n", __func__, buffer[0]);
...
#ifdef BUILD_LK
	printf("%s,  otm1284a+cmi id = 0x%08x\n", __func__, id);
#else
	printk("%s,  otm1284a+cmi id = 0x%08x\n", __func__, id);
#endif
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_otm1284a_dsi_vdo_hd_cmi = 
{
    .name           = "hct_otm1284a_dsi_vdo_hd_cmi",
