...
{0xB2,5,{0x65,0x80,0x64,0x10,0x07}},
//{0xB4,21,{0x26,0x80,0x26,0x80,0x26,0x26,0x01,0x01,0xFF,0x35,0x00,0x3F,0x26,0x80,0x26,0x80,0x26,0x26,0x01,0x01,0xFF}},
{0xB4,21,{0x26,0x80,0x26,0x80,0x26,0x26,0x01,0x01,0xFF,0x66,0x00,0x3F,0x26,0x80,0x26,0x80,0x26,0x26,0x01,0x01,0xFF}},
{0xD3,33,{0x00,0x00,0x06,0x06,0x01,0x01,0x10,0x10,0x32,0x10,0x00,0x00,0x00,0x32,0x15,0x04,0x05,0x04,0x32,0x15,0x14,0x05,0x14,0x37,0x33,0x04,0x04,0x37,0x00,0x00,0x47,0x05,0x40}},
...
{0xE0,58,{0x00,0x03,0x0B,0x0E,0x10,0x13,0x17,0x15,0x2D,0x3D,0x51,0x51,0x5E,0x75,0x7C,0x84,0x94,0x9A,0x98,0xA6,0xB2,0x57,0x57,0x5A,0x60,0x64,0x6A,0x7f,0x7F,0x00,0x03,0x0B,0x0E,0x10,0x13,0x17,0x15,0x2D,0x3D,0x51,0x51,0x5E,0x75,0x7C,0x84,0x94,0x9A,0x98,0xA6,0xB2,0x57,0x57,0x5A,0x60,0x64,0x6A,0x7f,0x7F}},
{0xB6,2,{0x34,0x34}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_sync_active				= 15;//38//15
	params->dsi.horizontal_backporch				= 70;//38//70
	params->dsi.horizontal_frontporch				= 65;//38//65
	//params->dsi.horizontal_blanking_pixel		       		= 60;
	params->dsi.horizontal_active_pixel		       		= FRAME_WIDTH;
	// Bit rate calculation

	params->dsi.PLL_CLOCK=202;//190;//227;//254;//254//247  240
}
...
// ---------------------------------------------------------------------------
LCM_DRIVER hct_hx8394f_dsi_vdo_hd_auo2 = 
{
	.name			  = "hct_hx8394f_dsi_vdo_hd_auo2",
