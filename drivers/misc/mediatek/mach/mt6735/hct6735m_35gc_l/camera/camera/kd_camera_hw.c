...
#if defined(CONFIG_T99_PROJ)||defined(CONFIG_T991_PROJ)
#define SUB_VGP1_USE_DVDD_1V8
#endif
...
#endif
#if defined(GC5004_MIPI_RAW)  // DVDD only 1v5
...
static void config_sensor_rst_pwd(char *currSensorName)
{
	...
	PK_DBG("[imgsensor_poweron] config_sensor_rst_pwd mainrst=%d, mainpwd=%d, subrst=%d, subpwd=%d, %s %s %s\n",g_main_rst_output_when_sensor_disable, g_main_pwd_output_when_sensor_disable, g_sub_rst_output_when_sensor_disable, g_sub_pwd_output_when_sensor_disable,currSensorName, g_MainSensorName,g_SubSensorName);	
