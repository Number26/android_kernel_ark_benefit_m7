...
#if defined(CONFIG_T93H_KLT_PROJ)
...
#if defined(CONFIG_T89P_YX_PROJ)||defined(CONFIG_T991_PROJ)
#define AC_CHARGER_CURRENT					CHARGE_CURRENT_2700_00_MA
#elif defined(CONFIG_T925M_DH_PROJ)||defined(CONFIG_T89_HD_PROJ)
...
/* charger error check */
#if defined(CONFIG_T93H_KLT_PROJ)||defined(CONFIG_T89P_YX_PROJ)
...
#define NPERCENT_TRACKING_TIME	   			100	// 100 second
#else
