...
extern void DSI_Get_Current_CLK(DISP_MODULE_ENUM module, unsigned int *clk);
...
//add by hct 2015.11.11
		DSI_Get_Current_CLK(DISP_MODULE_DSI0, &speed);
...
//add by hct 2015.11.11
			DSI_ChangeClk(DISP_MODULE_DSI0,speed);
