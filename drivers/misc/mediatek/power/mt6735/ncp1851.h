...
#define CUST_EINT_CHR_STAT_TYPE (EINTF_TRIGGER_RISING | EINTF_TRIGGER_FALLING)
...
#if 1//lisong 2014-8-19 [NO BUGID][fix bug:ncp1851 otg vbus overload]start
//CON6
extern kal_uint32 ncp1851_get_vbusilim(void);
#endif//lisong 2014-8-19 [NO BUGID][fix bug:ncp1851 otg vbus overload]end
...
#if 1//lisong 2014-8-19 [NO BUGID][fix bug:ncp1851 otg vbus overload]start
//CON13
extern void ncp1851_set_vbusilim_mask(kal_uint32 val);
#endif//lisong 2014-8-19 [NO BUGID][fix bug:ncp1851 otg vbus overload]end
