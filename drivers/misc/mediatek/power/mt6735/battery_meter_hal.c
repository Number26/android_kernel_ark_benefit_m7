...
static kal_int32 read_adc_v_bat_sense(void *data)
{
    ...
    *(kal_int32*)(data) = 4201;
#else
#if defined(CONFIG_T933_PROJ)||defined(CONFIG_T935_PROJ)
#if defined(SWCHR_POWER_PATH)
	*(kal_int32*)(data) = PMIC_IMM_GetOneChannelValue(MT6328_AUX_ISENSE_AP,*(kal_int32*)(data),1)+40;
#else
    *(kal_int32*)(data) = PMIC_IMM_GetOneChannelValue(MT6328_AUX_BATSNS_AP,*(kal_int32*)(data),1)+40;
#endif
#else
#if defined(SWCHR_POWER_PATH)
