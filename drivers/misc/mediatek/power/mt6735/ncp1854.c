...
#elif defined(CONFIG_T985_PROJ)||defined(CONFIG_T991_PROJ)
	#define NCP1854_BUSNUM 2
#else
...
#if 0//defined(CONFIG_T89_PROJ)
//    hwPowerOn(PMIC_APP_MAIN_CAMERA_POWER_IO, VOL_1800, "NCP1854");
#endif
