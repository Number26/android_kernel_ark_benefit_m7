...
#ifdef GPIO_IRTX_PWR_EN_PIN
    mt_set_gpio_mode(GPIO_IRTX_PWR_EN_PIN, GPIO_MODE_00);
    mt_set_gpio_dir(GPIO_IRTX_PWR_EN_PIN, GPIO_DIR_OUT);
    mt_set_gpio_out(GPIO_IRTX_PWR_EN_PIN, GPIO_OUT_ONE);
#endif
...
static int dev_char_close(struct inode *inode, struct file *file)
{
    ...
    disable_clock(MT_CG_PERI_IRTX, "IRTX");
        ...
        mt_set_gpio_mode(GPIO_IRTX_PWR_EN_PIN, GPIO_MODE_00);
        mt_set_gpio_dir(GPIO_IRTX_PWR_EN_PIN, GPIO_DIR_OUT);
        mt_set_gpio_out(GPIO_IRTX_PWR_EN_PIN, GPIO_OUT_ZERO);
#endif
