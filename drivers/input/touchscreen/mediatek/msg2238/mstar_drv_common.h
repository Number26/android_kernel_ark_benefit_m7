...
#define CONFIG_TOUCH_DRIVER_RUN_ON_MTK_PLATFORM   //w5
...
#define CONFIG_ENABLE_CHIP_MSG22XX  //w5
...
#define CONFIG_USE_IRQ_INTERRUPT_FOR_MTK_PLATFORM  //w5
...
#if defined(CTP_PROXIMITY_SUPPORT)
#define TPD_PROXIMITY   //only for MTK
#endif
...
#ifdef CONFIG_ENABLE_CHIP_MSG22XX
 ...
 */
#define TOUCH_SCREEN_X_MAX   (540) //LCD_WIDTH
