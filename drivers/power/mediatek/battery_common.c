...
#ifndef V1PERCENT_HOLD_TIME
#if Q_MAX_POS_25>5000
#define V1PERCENT_HOLD_TIME 1000
#else
#define V1PERCENT_HOLD_TIME 700
#endif
#endif
	...
	if ((BMT_status.ZCV <= BMT_status.nPercent_ZCV)
		...
		battery_log(BAT_LOG_CRTI,
		   ...
		   && (BMT_status.UI_SOC == BMT_status.nPrecent_UI_SOC_check_point)
           		...
           		&&(BMT_status.nPrecent_UI_SOC_check_point>1) // means if this soc is 1%, we need not hold
			#endif	
		) {
		...
		battery_log(BAT_LOG_CRTI,
             ...
             if (timer_counter == (V1PERCENT_HOLD_TIME / BAT_TASK_PERIOD))   /* every x sec decrease UI percentage */
             {
                 ...
                 printk("1Percent: more need statable trackcount=%d\n", timer_counter);
                 return resetBatteryMeter;
             }
